...
<html>
    <head>
        <title>Tere tulemast lehele <? print $host; ?>!</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.ee/"><img src="http://www.main-hosting.com/hostinger/welcome/images/logo.png" alt="Web hosting" /></a>
                </div>
                <div class="content">
                    <h1>Sinu konto on loodud!</h1>
                    <p>Veebileht <b><? print $host; ?></b> on edukalt siia serverisse paigaldatud! Palun kustuta kaustast <b>public_html</b> fail <b>default.php</b> ja lae oma veebileht failihalduri või FTP abil üles.</p>
                    <p>Siin on nimekiri kausta public_html failidest:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.ee/veebimajutus" target="_blank">Veebimajutus</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.ee/tasuta-majutus" target="_blank">Tasuta majutus</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.ee/forum" target="_blank">Tugifoorum</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.ee/" target="_blank">Kliendiala</a>
                </div>
                <div class="copyright">Hostinger &copy; <? print date('Y'); ?>. Kõik õigused reserveeritud.</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.ee"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
